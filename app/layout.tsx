  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <div className="bg-[#dbd7fb] absolute top-[-1rem] -z-10 left-[-35rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:lef-[-28rem] xl:left-[-15rm] 2xl:left-[-5rem]"></div>
        <Header />
        {children}
      </body>
    </html>
